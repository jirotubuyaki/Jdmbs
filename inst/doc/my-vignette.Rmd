...
* sigma is a vector of parameters of geometric brown motions.
* K is a vector of option execution prices.
* color is a vector of colors in plot.
* return is premium of a list with (call_premium, put_premium)

```{r, echo=FALSE, fig.width=60, fig.align='center', fig.height=28, dpi=300,out.width='16.5cm'}
load("../data/data.rda")
source('../R/Jdmbs.R')
