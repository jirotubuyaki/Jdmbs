---
title: "Jdmbs: An R Package for Monte Carlo Option Pricing Algorithms for Jump Diffusion Models with Correlational Companies"
subtitle: 'A Vignette'
author: |
  | Masashi Okada
...
## Conclusions
New algorithms for option prices were described and explained how to use it. This package can produce option prices with related companies. And several improvements are planed. Please send suggestions and report bugs to okadaalgorithm@gmail.com.
