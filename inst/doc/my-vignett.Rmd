...
* sigma is a list of parameters of geometric brown motions.
* K is a list of option execution prices.
* color is a list of colors in plot.

```{r, echo=FALSE, fig.width=60, fig.height=30, dpi=300,out.width='16.5cm'}
...
　　　　　　　　　　　Figure1: Simulation Result of Geometric Brownian Motion
