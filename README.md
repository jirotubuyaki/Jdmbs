...
carlo algorithm of proposed model. After simulate this model comparing with standard jump model and change parameters, we discuss effectiveness of it.
</div>
## Introduction
<div style="text-align: justify">
...
<center>Table 1: Result for correlation coefficents of companies</center>
